...
class PileAffichage : public QWidget
{
    Q_OBJECT
...
public:
    ...
    void UNDO();
    void REDO();
    QString WHILE(Litterale *, Litterale *);
...
public:
    ...
    void push(Litterale *);
    void clear();
    Litterale *getExpression(const QString) const;
    bool existe(QString) const;
